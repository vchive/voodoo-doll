...
- 2026-09-21 融合版通过 `hex/play-overview.ts` / `hex/play-overview-model.ts` 复用该人物绘制及合法房间家具布局，补齐 11 个地点的俯视示意。仅在融合模式给 A/B/C 提供与现有立绘相近的发色/服装配色；不声称精确像素化了原立绘，旧模式默认外观保留。
