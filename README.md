...
当前教程保留确定性的关键剧情；林川的普通生活聊天已接入带人物设定、当前日程和
本人记忆的角色适配器，无模型时有本地回应。沈青、周野仍使用预写稿件。
自主计划、NPC 之间的持续互动、职责模型路由与世界观察者纠偏尚未完成，最新状态见
...
- 教程中与林川同场时，可从自由行动选择“聊聊工作”“问他还记得什么”；已确认的话进入本人记忆，取消的输入不会。普通聊天仍耗时，关键剧情和结局需明确行动。
- 三位主要人物的默认立绘与表情、六张场景背景、说话高亮及已确认动作的轻量演出；来源见 [美术署名](CREDITS.md)。没有素材的人物/地点仍可继续文字玩法。
- 探索时看房间与在场人物，对话时看立绘；小俯视图可收起/展开并记住偏好，也可切换视角。点俯视人物先预览交谈，人物重叠时先选交谈对象，确认后才行动。室内站位是展示布局，不是新的自由行走规则。
- 当前页内从行动窗口、取消预览或故事库返回时，长对白接着原位置读；新一句或执行新行动后从头显示。句内位置不跨刷新保存。
