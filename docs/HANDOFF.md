...
> 最新更新：2026-09-21。用户要求继续优化，MW-42 / SP-27 / MW-AC-42 本机桌面已测范围完成：修复读到长句中段后，取消预览、行动返回或故事库往返导致正文回顶部。当前页回到同句接着读，下一句和实际新行动从头；仅内存书签，不改 API/存档/世界时钟，不承诺句内位置跨刷新保存。见[阅读恢复证据](evidence/2026-09-21-reading-resume.md)。
