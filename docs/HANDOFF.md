...
> 最新更新：2026-09-21。用户要求界面像 Galgame，并补齐人物立绘和动作细节。MW-38 / SP-23 / MW-AC-38：新默认单人舞台采用场景背景、在场人物立绘、底部统一对白/选择窗；巫毒娃娃继续负责旁白。林川、沈青、周野共十张表情立绘，六张场景背景，轻量进入/退场、说话突出和确认动作提示；无完整姿态、口型或 Live2D。旧 PixiJS 舞台仍在旧模式。证据见 [Galgame 舞台](evidence/2026-09-21-galgame-stage.md)，表现层边界见 [决策 0009](decisions/0009-galgame-presentation.md)。
