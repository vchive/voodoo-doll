...
> 最新更新：2026-09-21。用户要求继续优化，MW-41 / SP-26 / MW-AC-41 本机桌面已测范围完成：修复短横屏 B/C 热点重叠误选，重叠时先明确选择对象，再走原预览/确认；取消零行动，更新场景/禁用/停止时关闭旧候选。三人立绘避开顶部控件，窄竖屏重新分配站位；原小图收放保留。见[多人舞台证据](evidence/2026-09-21-multicast-stage.md)与[决策 0010](decisions/0010-hybrid-exploration-presentation.md)的 MW-41 补充。
