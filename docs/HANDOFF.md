...
> 最新更新：2026-09-21。用户要求立绘过程中自由最小化俯视房间。MW-40 / SP-25 / MW-AC-40 本机桌面范围完成：小图“−”收起、“展开房间”恢复，独立本机偏好跨翻页/换场/刷新保持；探索仍显示完整房间，回立绘恢复偏好。两种纯显示按钮在待确认时可用，人物/行动锁保持，不改世界/存档/阅读。见[小图收放证据](evidence/2026-09-21-overview-disclosure.md)及[决策 0010](decisions/0010-hybrid-exploration-presentation.md)的 MW-40 补充。
