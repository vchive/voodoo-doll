...
当前默认signal-rain-v1的MW-AC-28–31保持部分完成/待证据，实际命令、HTTP、浏览器路线与未测项以[2026-09-20-signal-story.md](../../evidence/2026-09-20-signal-story.md)逐项记录为准。约135句/4,372汉字和构建成功不能证明故事质量、长篇时长或预发布可用性。
