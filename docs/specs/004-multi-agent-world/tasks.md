...
本轮（2026-09-21，MW-40 / SP-25 / MW-AC-40）：本机桌面已测范围完成。立绘小图可收起/展开，探索保持完整显示，本机偏好独立保存。四尺寸融合专项 5/5（26 次真实收放，含偏好存储失败）及相关回归 13/13 通过；类型检查、Hex 构建通过，见[小图收起证据](../../evidence/2026-09-21-overview-disclosure.md)。本轮未重跑 Node/Python 单元或根构建；请求/导入进行中控件豁免为实现检查，pending 已实测，真机与公网另验。
